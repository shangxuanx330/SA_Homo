...
save_path="results/rgb_nir"
echo $save_path
script_dir=$(cd "$(dirname "$0")" && pwd)
script_path="$script_dir/$(basename "$0")"
SCEM_model=ckpts/rgb_nir/scale_variation/scem.pt
IHERM_model=ckpts/rgb_nir/scale_variation/iherm.pt
