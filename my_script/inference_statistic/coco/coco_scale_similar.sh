...
save_path="results/coco/scale_similar"
echo $save_path
script_dir=$(cd "$(dirname "$0")" && pwd)
script_path="$script_dir/$(basename "$0")"
SCEM_model=ckpts/coco/sclae_similar/scem.pt
IHERM_model=ckpts/coco/sclae_similar/iherm.pt
...
python inference/SA_Homo_inference.py \
  ...
  --val_dataset_folder_name "crop_ratio_1_1_margin_0_0" \
  --attn_type MLA \
