...
save_path="results/hmsa/scale_similar"
echo $save_path
script_dir=$(cd "$(dirname "$0")" && pwd)
script_path="$script_dir/$(basename "$0")"
SCEM_model=ckpts/hmsa/scale_similar/scem.pt
IHERM_model=ckpts/hmsa/scale_similar/iherm.pt
...
python inference/SA_Homo_inference.py \
  ...
  --val_dataset_folder_name "crop_ratio_1_1_margin_25p" \
  --attn_type MLA \
