...
save_path="results/hmsa/scale_variation/runtime"
echo $save_path
script_dir=$(cd "$(dirname "$0")" && pwd)
script_path="$script_dir/$(basename "$0")"
SCEM_model=ckpts/hmsa/scale_variation/scem.pt
IHERM_model=ckpts/hmsa/scale_variation/iherm.pt
...
python inference/SA_Homo_visualization.py \
  ...
  --dataset_list "datasets/hmsa_1152x1152" \
  --val_dataset_folder_name "crop_ratio_1_5_margin_25p" \
  --is_val_static \
  --attn_type MLA \
